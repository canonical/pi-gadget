...
The pi snap has regular releases that are fully automated. There are two 
...
Security vulnerabilities that apply to packages staged by the pi snap in the Ubuntu 18.04 LTS
archives. Any vulnerability that allows the pi snap to interfere outside 
